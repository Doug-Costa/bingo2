...
export function useFitText(
  ...
  max: number,
  min: number,
  overflow: 'wrap' | 'ellipsis' = 'wrap',
  /** Remede quando a LARGURA da área muda depois (ex.: outro elemento da linha
   * aparece/some). Use só com áreas cujo tamanho não depende do próprio texto. */
  observe = false,
) {
