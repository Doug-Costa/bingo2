    ...
    <BingoShowTopWinnersFrame style={{ width: '100%', height: '100%', ...style }}>
      ...
      <div
        style={{
          ...
          alignItems: 'center',
          height: 64,
          borderBottom: `2px solid ${BingoShowColors.cyanNeon}55`,
          marginBottom: 8,
          paddingLeft: 8,
          paddingRight: 8,
        }}
      >
        <span style={{ width: '28%', fontSize: 22, fontWeight: 900, color: BingoShowColors.cyanNeon, letterSpacing: 2 }}>CUPOM</span>
        <span style={{ width: '40%', fontSize: 22, fontWeight: 900, color: BingoShowColors.cyanNeon, letterSpacing: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>DOADOR</span>
        <span style={{ width: '32%', fontSize: 22, fontWeight: 900, color: BingoShowColors.cyanNeon, letterSpacing: 2, textAlign: 'center' }}>FALTAM</span>
      </div>
            ...
            >
              ...
              <div style={{ width: '28%' }}>
                {hasData ? (
                  ...
                  <span style={{ color: BingoShowColors.textMuted, fontSize: 20 }}>---</span>
                )}
              </div>
              ...
              <span
                style={{
                  ...
                  fontSize: 22,
                  fontWeight: 700,
                  color: hasData ? BingoShowColors.textPrimary : BingoShowColors.textMuted,
                  overflow: 'hidden',
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          height: 30,
                          borderRadius: '50%',
                          backgroundColor: BingoShowColors.primary,
                          color: '#000000',
                          fontSize: 16,
                          fontWeight: 900,
                          display: 'flex',
